        ...
        <div class="w-full mx-auto flex flex-wrap">
            <div class="flex w-full md:w-1/2 ">
                <div class="px-8">
                    ...
                    <p class="py-6 text-gray-600 text-sm">
                        Speggo Frontend 1.0 2021 by DARKSKALD
                    </p>
                </div>
            </div>
            ...
            <div class="flex w-full md:w-1/2">
                <div class="px-8">
                    <h3 class="font-bold font-bold text-gray-100">Source</h3>
                    <ul class="list-reset items-center text-sm pt-3">
                        <li>
                            <a class="inline-block text-gray-600 no-underline hover:text-gray-100 hover:text-underline py-1"
                               href="https://github.com/Darkskald/speggo">checkout on GitHub</a>
                        </li>
                    </ul>
                </div>
            </div>
