    ...
    <div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
            ...
            <div class="flex relative inline-block float-right">
                ...
                <div class="relative text-sm text-gray-100">
                    <button id="userButton" class="flex items-center focus:outline-none mr-3">
                        <img class="w-8 h-8 rounded-full mr-4" src="dslogo.png" alt="Avatar of User"> <span
                            class="hidden md:inline-block text-gray-100">Hi, Florian</span>
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-gray-900 z-20"
            ...
            <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                ...
                <li class="mr-6 my-2 md:my-0">
                    <a href="#" on:click={()=>state="analysis"}
                ...
                <li class="mr-6 my-2 md:my-0">
                    <a href="#"
                       class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-gray-900  hover:border-red-400">
                        <i class="fa fa-anchor fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">SML</span>
                    </a>
                </li>
            </ul>
